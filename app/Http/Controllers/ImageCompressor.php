...
class ImageCompressor extends Controller
{
    //
    ...
    function invoke(){
                        ...
                        if (filter_var(urldecode($image_uri), FILTER_VALIDATE_URL)) {
                            ...
                            try{
                                ...
                                $status_code = $request->getStatusCode();
                                    ...
                                    return view('index',['image_compressor'=>true,'error_message'=>'The image uri might be expired...']);
                            ...
                            if ($exists) {
                                ...
                                if ($split_mime[0] == 'image') {
                                    if (in_array(strtolower($split_mime[1]),IMAGE_OPTIMIZER_MIME_TYPES)) {
                                        ...
                                        return redirect('image-compressor/action?url=' . $saved_uri);

                                    }

                                    else{

                                        return view('index',['image_compressor'=>true,'error_message'=>'Unsupported file format... or The uploaded file format currently not supported...']);
                                    ...
                                    return view('index',['image_compressor'=>true,'error_message'=>'Only upload image file...']);
                            ...
                            if(substr($image_uri, 0, 5) == 'data:'){
                                    ...
                                    try{
                                        ...
                                        if ($mime_type=='text/plain'){
                                            ...
                                            return view('index',['image_compressor'=>true,'error_message'=>'The image uri might be expired... or broken']);
                                ...
                                return redirect('/image-compressor');
                            }
        ...
        return view('index', ['image_compressor' => true]);
    ...
    if ( (file_exists($choose_file['tmp_name']) && getimagesize($choose_file['tmp_name'])>0 && !empty($choose_file))  || !empty(
        ...
        return view('index',['image_compressor'=>true,'error_message'=>'Hey please upload image to further process...']);
                    ...
                    if (isset($get_array['url'])) {
                        ...
                        if (filter_var($image_uri, FILTER_VALIDATE_URL)) {
                            ...
                            if($status_code==200)
                            {
                                ...
                                if (in_array($split_mime[0],IMAGE_OPTIMIZER_FILE_TYPES)) {
                                    if (in_array(strtolower($split_mime[1]),IMAGE_OPTIMIZER_MIME_TYPES)) {
                                        ...
                                        if(file_exists($path)){
                                            ...
                                            return view('index',['image_compressor_upload'=>true,

                                            'fileInfo'=>$fileInfo,
                                            'formUrl'=>'/image-compressor/action?url='.$image_uri,
                                            'imageUri'=>$image_uri
                                ...
                                return view('index',['image_compressor'=>true,'error_message'=>'Unsupported uri... or malformed uri...']);
    ...
    $resize_perc = $_POST['compress-perc'];
    ...
    $imagicImage->setImageCompressionQuality(intval($r_p));
    ...
    $imagicImage->stripImage();
                                                ...
                                                $fileInfo=new \FileInfo(
                                                    ...
                                                    $width,$height,getColorSpace(
                                                        intval($mode)
                                                    ),$size,$fileType,$fileFormat
                                               ...
                                               ,intval(getPercentageChange(
                                                ...
                                                return view('index',['image_compressor_download'=>true,
