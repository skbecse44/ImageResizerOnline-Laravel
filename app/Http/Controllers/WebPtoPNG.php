...
class WebPtoPNG extends Controller
{
    //
    ...
    function invoke(){
                        ...
                        if (filter_var($image_uri, FILTER_VALIDATE_URL)) {
                            ...
                            try{
                                ...
                                $statusCode = $request->getStatusCode();
                                    ...
                                    return view('index',['image_webptopng'=>true,'error_message'=>'The image uri might be expired...']);
                            ...
                            if ($exists) {
                                ...
                                if ($split_mime[0] == 'image') {
                                    if (in_array(strtolower($split_mime[1]),array('jpg', 'jpeg', 'png', 'tiff', 'webp'))) {
                                        ...
                                        return redirect('image-converter/webp-to-png/action?url=' . $saved_uri);

                                    }

                                    else{

                                        return view('index',['image_webptopng'=>true,'error_message'=>'Unsupported file format... or The uploaded file format currently not supported...']);
                                    ...
                                    return view('index',['image_webptopng'=>true,'error_message'=>'Only upload image file...']);
                            ...
                            if(substr($image_uri, 0, 5) == 'data:'){
                                    ...
                                    try{
                                        ...
                                        if ($mime_type=='text/plain'){
                                            ...
                                            return view('index',['image_webptopng'=>true,'error_message'=>'The image uri might be expired... or broken']);
                                ...
                                return redirect('/image-converter/webp-to-png');
                            }
        ...
        return view('index', ['image_webptopng' => true]);
        ...
        if ($zip->open('media/data/zips/'.$zip_name, \ZipArchive::CREATE) === TRUE)
{
                ...
                parse_str($q_s, $get_array);
                    ...
                    if (isset($get_array['url'])) {
                        ...
                        if (filter_var($image_uri, FILTER_VALIDATE_URL)) {
                            ...
                            return redirect(
                                'image-converter/webp-to-png?url='.$image_uri
                            );
                           }
                            ...
                            if ($split_mime[0] == 'image') {
                                ...
                                if (in_array($split_mime[1],array('jpg', 'jpeg', 'png', 'tiff', 'webp'))) {
                                 ...
                                 return view('index',['image_webptopng_upload'=>true,
                                 ...
                                 'formUrl'=>'/image-converter/webp-to-png/action?url='.$image_uri,
                                 'imageUri'=>$image_uri,
    ...
    if (filter_var($image_uri, FILTER_VALIDATE_URL)) {
        ...
        $status_code = $request->getStatusCode();
            ...
            redirect('/image-converter/webp-to-png');
        }
                        if($status_code==200)
                        {
                            $mime_type =$request->getHeaderLine('Content-Type');
                            ...
                            if ($split_mime[0] == 'image') {
                                ...
                                if (in_array($split_mime[1],array('jpg', 'jpeg', 'png', 'tiff', 'webp','gif'))) {
                                    ...
                                    $ufn= get_unqiue_file_name('media/download/'.$document.'/','png');
           ...
           ,null
            ...
            return view('index',['image_webptopng_download'=>true,
