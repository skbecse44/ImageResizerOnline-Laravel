<h1 style="font-weight: 400">Compress Image Online Under2MB</h1>
...
">
        ...
        <form method="POST" action="/image-compressor/under2mb"
...
@if(isset($image_compressor_under2048kb))
...
>
    ...
    ">
        ...
        /image-converter/under2mb?url=https://example.com/source-image.gif
...
<h1>
    ...
    Image Compressor Online Under2MB
</h1>
    ...
    >
        ...
        Compressor do its job. You simply browse go to www.imageresizeronline.com/image-compressor/under2mb and upload the images you want to compress. The file formats supported by Simple Image Compressor include JPEG, PNG , WEBP, GIF and All other image formats.
