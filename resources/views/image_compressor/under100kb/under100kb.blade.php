<h1 style="font-weight: 400">Compress Image Online Under100KB</h1>
...
">
        ...
        <form method="POST" action="/image-compressor/under100kb"
...
@if(isset($image_compressor_under100kb))
...
<h1>
    ...
    Image Compressor Online Under100KB
</h1>
    ...
    "
    >
        There is no need to install any additional software on your computer to make Simple Image Compressor do its job. You simply browse go to www.imageresizeronline.com/image-compressor/under100kb and upload the images you want to compress. The file formats supported by Simple Image Compressor include JPEG, PNG , WEBP, GIF and All other image formats.
